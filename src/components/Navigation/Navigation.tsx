...
const Navigation = () => {
  ...
  const links = [
    ...
    { name: 'Feed Management', path: '/feed', icon: <Utensils className="h-5 w-5" /> },
    ...
    { name: 'Customers', path: '/customers', icon: <FileText className="h-5 w-5" /> },
    { name: 'Calendar', path: '/calendar', icon: <Calendar className="h-5 w-5" /> },
    { name: 'Warehouse', path: '/warehouse', icon: <Package className="h-5 w-5" /> },
    { name: 'User Management', path: '/users', icon: <UserCog className="h-5 w-5" /> },
  ];
